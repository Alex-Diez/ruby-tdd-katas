...
describe 'k items' do
  ...
  it 'has to filter one item from two items array larger is first one' do
    expect(k_items([2, 1], 1)).to eq([2])
  end

  it 'has to filter one item from two items array larger is last one' do

...
require 'longest_palindrome_substring/day02'
...
class LongestPalindromeSubstringTest < Minitest::Test
  ...
  def test_single_char_string_is_substring_to_itself
    assert_equal 'a', @palindrome.longest_substring('a')
  end

  def test_doubled_char_string_is_substring_to_itself
  ...
  def test_palindrome_at_the_end
    assert_equal 'aba', @palindrome.longest_substring('asdfghjklaba')
  end
end

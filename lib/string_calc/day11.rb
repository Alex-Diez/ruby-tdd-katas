...
class StringCalc
  ...
  class Parser
    def initialize(expr)
      ...
      @low_priority_operators = %i[- +]
      @high_priority_operators = %i[* /]
    end

    def parse_expression
      num = parse_term
      while @low_priority_operators.include?((operator = parse_operator))
        skip_current_char
    ...
    def parse_term
      num = parse_argument
      while @high_priority_operators.include?((operator = parse_operator))
        skip_current_char
